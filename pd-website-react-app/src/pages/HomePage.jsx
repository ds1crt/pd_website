        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <section className="text-center min-h-[70vh] flex flex-col items-center justify-center">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
                    <NavLink to="/contact" className="inline-flex items-center gap-2 px-8 py-3 font-semibold bg-sky-500 text-white rounded-lg shadow-lg hover:bg-sky-600">
                        <FiSend /> İletişime Geçin
                    </NavLink>
                </motion.div>
            </section>
        </div>
